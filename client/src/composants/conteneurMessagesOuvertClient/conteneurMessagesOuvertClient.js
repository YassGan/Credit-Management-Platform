...
import './conteneurMessagesOuvertClient.css'
...
{
id:'1',
idClient:localStorage.getItem("IdSessionClient"),
...
UrlPhotoClient:localStorage.getItem("PhotoProfilSessionClient"),
NomClient:localStorage.getItem("nomSessionCLient"),
PrénomClient:localStorage.getItem("prenomSessionCLient"),
DateTri:Date()
