...
import validateico from '../images/validateico.png'
...
const ConteneurDemandesValidées=()=>{
    ...
    useEffect(()=>{
        axios.get("http://localhost:3001/getDemandes").then((response)=>{
          ...
          for (TabEnC in tabDemandes){
              if(tabDemandes[TabEnC].statutGlobal==="Demande Validée"){
                            ...
                            <div className='liste2buttonsContainer'> 
                               ...
                               <Link to='/p6'>
                                ...
                                <div className='ListeClientsButton ListeClients'>
                                    ...
                                    <h3 className='tit'> Liste des demandes en cours</h3>
                                    </div>
                                </div>
                            ...
                            TabEnCours.map((e)=>{        
                                 ...
                                 return(
                                    ...
                                    <div className='title_elementdemande XmarkContainer'>  
                                       ...
                                       <img onClick={() =>{ConsulterFunction(e._id)}} className="iii" id="Xmark" src={Xmark}/>
                                  </div>
...
export default ConteneurDemandesValidées;