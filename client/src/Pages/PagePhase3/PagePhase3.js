    ...
    <div className='containerPageProfilClient'>
        ...
        <SidebarClient></SidebarClient>
            ...
            <div className='client_main'>
                <TitreDuMain titre={"Phase 3 : Etude du dossier"} description={"Dans cette phase nous faisons l'étude de votre demande et nous vérifions les documents que vous avez scanné. "}></TitreDuMain>
