...
function PagePhase2CréditEslahPourVérif() {
    ...
    localStorage.setItem("Devis des travaux","https://previews.123rf.com/images/cthoman/cthoman1507/cthoman150703921/42751294-une-illustration-de-bande-dessin%C3%A9e-d-un-document-vierge-debout-.jpg")
    localStorage.setItem("UrlDevisTravauxStatut","Pas enocre")
        ...
        for (iDD in tabTouteslesDemandes){
          ...
          for (iRe in tabTousLesDocumentsVerifAdmin){
            ...
            if(tabTousLesDocumentsVerifAdmin[iRe].typeDocument==="VersoDocumentCIN"){
                ...
                if(tabTousLesDocumentsVerifAdmin[iRe].typeDocument==="DevisTravaux "){
                    console.log("Devis des travaux  trouvée")
                    localStorage.setItem("Devis des travaux",tabTousLesDocumentsVerifAdmin[iRe].Url)
                    localStorage.setItem("_idDevisTravaux",tabTousLesDocumentsVerifAdmin[iRe]._id)
                    localStorage.setItem("UrlDevisTravauxStatut",tabTousLesDocumentsVerifAdmin[iRe].statutDoc)                    
                }
                 ...
                 <div className="ListeDocumentesWrapper">
                  <div className="listeDocumentsContainer">
                   <div className="listeDocuments">
                    ...
                    <div className="DocBoxContainer">
                     <DoxBoxVérification  statutDoc={localStorage.getItem("UrlDevisTravauxStatut")}  UrlDocument={localStorage.getItem("Devis des travaux")}  titre={"Le devis des travaux : "+localStorage.getItem("UrlDevisTravauxStatut")} photoimgBoxContainerScale="imgBoxContainerDemandeDocumantNormal"  photoimgBoxScale="imgScaleNormalDocument" photoDemandeBoxScale=""></DoxBoxVérification>
...
export default PagePhase2CréditEslahPourVérif;
