...
import ConteneurDemandesValidées from "../../composants/conteneur_demandes_en_cours/conteneur_demandes_en_cours";
    ...
    return(
        <div className="PageAdminListeDemandesContainer">
            ...
            <div className="titreduMainContainer">
               ...
               <ConteneurDemandesValidées></ConteneurDemandesValidées>
            </div>
