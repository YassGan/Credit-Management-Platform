    ...
    <div className='containerPageProfilClient'>
        ...
        <SidebarClient></SidebarClient>
            ...
            <div className='client_main'>
                <TitreDuMain titre={"Phase 1 : Simulation du crédit et initiation de la demande"} description={"La phase 1 représente le choix et la simulation de votre crédit, voici les informations de votre demande: "}></TitreDuMain>
